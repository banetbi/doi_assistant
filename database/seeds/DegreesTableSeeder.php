...
class DegreesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach($arrDegrees as $key => $value) {
            $objDegree =  new \DoiAssistant\Degree();
            $objDegree->abbreviation = strtolower($key);
            $objDegree->degree = $value;
            $objDegree->save();
        }
    }
}
